    ...
    actions
    {
        area(Processing)
        {
            ...
            action(ClearDeletedRecordsList)
            {
                ...
                ToolTip = 'Removes exported entries from the deleted record list. Perform this periodically to free up storage. You can automate this process with a job queue using the ADLSE Clear Tracked Deletions codeunit.';
                Image = ClearLog;
